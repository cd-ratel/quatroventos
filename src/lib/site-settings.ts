...
export const defaultSiteSettings = {
  ...
  galleryContent: {
    ...
    placeholderMedia: [
      { id: '1', title: 'Salao Principal', category: 'venue', caption: 'Salao Grand Ventus', icon: '🏛️' },
      { id: '2', title: 'Decoracao Casamento', category: 'wedding', caption: 'Mesa dos Noivos', icon: '💐' },
      { id: '3', title: 'Jardim Externo', category: 'venue', caption: 'Area Externa', icon: '🌳' },
      { id: '4', title: 'Festa Infantil', category: 'children', caption: 'Espaco Kids', icon: '🎈' },
      { id: '5', title: 'Buffet', category: 'venue', caption: 'Area do Buffet', icon: '🍽️' },
      { id: '6', title: 'Cerimonia', category: 'wedding', caption: 'Altar ao Ar Livre', icon: '💒' },
      { id: '7', title: 'Reuniao', category: 'corporate', caption: 'Sala de Reunioes', icon: '🏢' },
      { id: '8', title: 'Decoracao', category: 'decoration', caption: 'Arranjo Floral', icon: '🌸' },
      { id: '9', title: 'Pista de Danca', category: 'venue', caption: 'Pista de Danca', icon: '💃' },
    ],
  ...
  bookingContent: {
    ...
    infoCards: [
      { icon: '🕐', title: 'Horario Comercial', desc: 'Seg a Sex: 09h as 18h | Sab: 09h as 14h' },
      { icon: '⏱️', title: 'Duracao da Visita', desc: 'Aproximadamente 30 a 45 minutos' },
      { icon: '✨', title: 'Visita Personalizada', desc: 'Tour completo por todos os espacos com atendimento exclusivo' },
      { icon: '💰', title: 'Sem Compromisso', desc: 'Visita gratuita e sem obrigacao de contratacao' },
    ],
